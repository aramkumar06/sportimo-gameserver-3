...
module.exports.decode = function (id, buf) {
    switch (id) {
        ...
        default: throw new Error("Unknown class/method ID");
    }
}
...
module.exports.encodeProperties = function (id, channel, size, fields) {
    switch (id) {
        ...
        default: throw new Error("Unknown class/properties ID");
    }
}
...
function encodeConnectionStart(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'serverProperties' is the wrong type; must be an object");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'mechanisms' is the wrong type; must be a Buffer");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'locales' is the wrong type; must be a Buffer");
    }
    varyingSize += val.length;
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'versionMajor' is the wrong type; must be a number (but not NaN)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'versionMinor' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt8(val, offset); offset++;
...
var methodInfoConnectionStart = module.exports.methodInfoConnectionStart = { "id": 655370, "name": "ConnectionStart", "args": [{ "type": "octet", "name": "versionMajor", "default": 0 }, { "type": "octet", "name": "versionMinor", "default": 9 }, { "type": "table", "name": "serverProperties" }, { "type": "longstr", "name": "mechanisms", "default": "PLAIN" }, { "type": "longstr", "name": "locales", "default": "en_US" }] };
...
function encodeConnectionStartOk(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'clientProperties' is the wrong type; must be an object");
    }
    len = encodeTable(SCRATCH, val, scratchOffset);
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'mechanism' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'response' is the wrong type; must be a Buffer");
    }
    varyingSize += val.length;
    val = fields['locale'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'locale' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    buffer[offset] = mechanism_len; offset++;
    buffer.write(val, offset, "utf8"); offset += mechanism_len;
    val = fields['response'];
    if (val === undefined) val = Buffer.from(undefined);
    len = val.length;
    buffer.writeUInt32BE(len, offset); offset += 4;
    val.copy(buffer, offset); offset += len;
    val = fields['locale'];
    if (val === undefined) val = "en_US";
    buffer[offset] = locale_len; offset++;
    buffer.write(val, offset, "utf8"); offset += locale_len;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
    return buffer;
}

var methodInfoConnectionStartOk = module.exports.methodInfoConnectionStartOk = { "id": 655371, "name": "ConnectionStartOk", "args": [{ "type": "table", "name": "clientProperties" }, { "type": "shortstr", "name": "mechanism", "default": "PLAIN" }, { "type": "longstr", "name": "response" }, { "type": "shortstr", "name": "locale", "default": "en_US" }] };
...
function encodeConnectionSecure(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'challenge' is the wrong type; must be a Buffer");
    }
    varyingSize += val.length;
...
var methodInfoConnectionSecure = module.exports.methodInfoConnectionSecure = { "id": 655380, "name": "ConnectionSecure", "args": [{ "type": "longstr", "name": "challenge" }] };
...
var methodInfoConnectionSecureOk = module.exports.methodInfoConnectionSecureOk = { "id": 655381, "name": "ConnectionSecureOk", "args": [{ "type": "longstr", "name": "response" }] };
...
function encodeConnectionTune(channel, fields) {
    var offset = 0, val = null, bits = 0, varyingSize = 0;
    var len, scratchOffset = 0;
    var buffer = Buffer.alloc(20 + varyingSize);
    buffer[0] = 1;
    buffer.writeUInt16BE(channel, 1);
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'channelMax' is the wrong type; must be a number (but not NaN)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'frameMax' is the wrong type; must be a number (but not NaN)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'heartbeat' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt16BE(val, offset); offset += 2;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
...
var methodInfoConnectionTune = module.exports.methodInfoConnectionTune = { "id": 655390, "name": "ConnectionTune", "args": [{ "type": "short", "name": "channelMax", "default": 0 }, { "type": "long", "name": "frameMax", "default": 0 }, { "type": "short", "name": "heartbeat", "default": 0 }] };
...
var methodInfoConnectionTuneOk = module.exports.methodInfoConnectionTuneOk = { "id": 655391, "name": "ConnectionTuneOk", "args": [{ "type": "short", "name": "channelMax", "default": 0 }, { "type": "long", "name": "frameMax", "default": 0 }, { "type": "short", "name": "heartbeat", "default": 0 }] };
...
function encodeConnectionOpen(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'virtualHost' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    buffer[offset] = virtualHost_len; offset++;
    buffer.write(val, offset, "utf8"); offset += virtualHost_len;
    val = fields['capabilities'];
    if (val === undefined) val = "";
    buffer[offset] = capabilities_len; offset++;
    buffer.write(val, offset, "utf8"); offset += capabilities_len;
    val = fields['insist'];
    if (val === undefined) {
        val = false;
    }
        ...
        throw new TypeError(
            "Field 'insist' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
...
var methodInfoConnectionOpen = module.exports.methodInfoConnectionOpen = { "id": 655400, "name": "ConnectionOpen", "args": [{ "type": "shortstr", "name": "virtualHost", "default": "/" }, { "type": "shortstr", "name": "capabilities", "default": "" }, { "type": "bit", "name": "insist", "default": false }] };
...
function encodeConnectionOpenOk(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'knownHosts' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    val = fields['knownHosts'];
    if (val === undefined) val = "";
    buffer[offset] = knownHosts_len; offset++;
    buffer.write(val, offset, "utf8"); offset += knownHosts_len;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
    return buffer;
}

var methodInfoConnectionOpenOk = module.exports.methodInfoConnectionOpenOk = { "id": 655401, "name": "ConnectionOpenOk", "args": [{ "type": "shortstr", "name": "knownHosts", "default": "" }] };
...
function encodeConnectionClose(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'replyText' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'replyCode' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt16BE(val, offset); offset += 2;
    val = fields['replyText'];
    if (val === undefined) val = "";
    buffer[offset] = replyText_len; offset++;
    buffer.write(val, offset, "utf8"); offset += replyText_len;
    val = fields['classId'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'classId' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt16BE(val, offset); offset += 2;
    val = fields['methodId'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'methodId' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt16BE(val, offset); offset += 2;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
...
var methodInfoConnectionClose = module.exports.methodInfoConnectionClose = { "id": 655410, "name": "ConnectionClose", "args": [{ "type": "short", "name": "replyCode" }, { "type": "shortstr", "name": "replyText", "default": "" }, { "type": "short", "name": "classId" }, { "type": "short", "name": "methodId" }] };
...
function encodeConnectionCloseOk(channel, fields) {
    var offset = 0, val = null, bits = 0, varyingSize = 0;
    var len, scratchOffset = 0;
    var buffer = Buffer.alloc(12 + varyingSize);
    buffer[0] = 1;
    buffer.writeUInt16BE(channel, 1);
...
var methodInfoConnectionCloseOk = module.exports.methodInfoConnectionCloseOk = { "id": 655411, "name": "ConnectionCloseOk", "args": [] };
...
function encodeConnectionBlocked(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'reason' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    val = fields['reason'];
    if (val === undefined) val = "";
    buffer[offset] = reason_len; offset++;
    buffer.write(val, offset, "utf8"); offset += reason_len;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
    return buffer;
}

var methodInfoConnectionBlocked = module.exports.methodInfoConnectionBlocked = { "id": 655420, "name": "ConnectionBlocked", "args": [{ "type": "shortstr", "name": "reason", "default": "" }] };
...
var methodInfoConnectionUnblocked = module.exports.methodInfoConnectionUnblocked = { "id": 655421, "name": "ConnectionUnblocked", "args": [] };
...
function encodeChannelOpen(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'outOfBand' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    val = fields['outOfBand'];
    if (val === undefined) val = "";
    buffer[offset] = outOfBand_len; offset++;
    buffer.write(val, offset, "utf8"); offset += outOfBand_len;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
    return buffer;
}

var methodInfoChannelOpen = module.exports.methodInfoChannelOpen = { "id": 1310730, "name": "ChannelOpen", "args": [{ "type": "shortstr", "name": "outOfBand", "default": "" }] };
...
function encodeChannelOpenOk(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'channelId' is the wrong type; must be a Buffer");
    }
    varyingSize += val.length;
    var buffer = Buffer.alloc(16 + varyingSize);
    buffer[0] = 1;
...
var methodInfoChannelOpenOk = module.exports.methodInfoChannelOpenOk = { "id": 1310731, "name": "ChannelOpenOk", "args": [{ "type": "longstr", "name": "channelId", "default": "" }] };
...
function encodeChannelFlow(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'active' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    buffer[offset] = bits; offset++;
    buffer[offset] = 206;
...
var methodInfoChannelFlow = module.exports.methodInfoChannelFlow = { "id": 1310740, "name": "ChannelFlow", "args": [{ "type": "bit", "name": "active" }] };
...
var methodInfoChannelFlowOk = module.exports.methodInfoChannelFlowOk = { "id": 1310741, "name": "ChannelFlowOk", "args": [{ "type": "bit", "name": "active" }] };
...
var methodInfoChannelClose = module.exports.methodInfoChannelClose = { "id": 1310760, "name": "ChannelClose", "args": [{ "type": "short", "name": "replyCode" }, { "type": "shortstr", "name": "replyText", "default": "" }, { "type": "short", "name": "classId" }, { "type": "short", "name": "methodId" }] };
...
var methodInfoChannelCloseOk = module.exports.methodInfoChannelCloseOk = { "id": 1310761, "name": "ChannelCloseOk", "args": [] };
...
function encodeAccessRequest(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'realm' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    buffer[offset] = realm_len; offset++;
    buffer.write(val, offset, "utf8"); offset += realm_len;
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'exclusive' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    val = fields['passive'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'passive' is the wrong type; must be booleany");
    }
    if (val) bits += 2;
    val = fields['active'];
    if (val === undefined) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'write' is the wrong type; must be booleany");
    }
    if (val) bits += 8;
    val = fields['read'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'read' is the wrong type; must be booleany");
    }
    if (val) bits += 16;
    buffer[offset] = bits; offset++;
    buffer[offset] = 206;
...
function encodeAccessRequestOk(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'ticket' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt16BE(val, offset); offset += 2;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
...
var methodInfoAccessRequestOk = module.exports.methodInfoAccessRequestOk = { "id": 1966091, "name": "AccessRequestOk", "args": [{ "type": "short", "name": "ticket", "default": 1 }] };
...
function encodeExchangeDeclare(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'exchange' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'type' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'arguments' is the wrong type; must be an object");
    }
    len = encodeTable(SCRATCH, val, scratchOffset);
    ...
    buffer[offset] = exchange_len; offset++;
    buffer.write(val, offset, "utf8"); offset += exchange_len;
    val = fields['type'];
    if (val === undefined) val = "direct";
    buffer[offset] = type_len; offset++;
    buffer.write(val, offset, "utf8"); offset += type_len;
    val = fields['passive'];
    if (val === undefined) {
        val = false;
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'durable' is the wrong type; must be booleany");
    }
    if (val) bits += 2;
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'autoDelete' is the wrong type; must be booleany");
    }
    if (val) bits += 4;
    val = fields['internal'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'internal' is the wrong type; must be booleany");
    }
    if (val) bits += 8;
    val = fields['nowait'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'nowait' is the wrong type; must be booleany");
    }
    if (val) bits += 16;
...
var methodInfoExchangeDeclare = module.exports.methodInfoExchangeDeclare = { "id": 2621450, "name": "ExchangeDeclare", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "exchange" }, { "type": "shortstr", "name": "type", "default": "direct" }, { "type": "bit", "name": "passive", "default": false }, { "type": "bit", "name": "durable", "default": false }, { "type": "bit", "name": "autoDelete", "default": false }, { "type": "bit", "name": "internal", "default": false }, { "type": "bit", "name": "nowait", "default": false }, { "type": "table", "name": "arguments", "default": {} }] };
...
var methodInfoExchangeDeclareOk = module.exports.methodInfoExchangeDeclareOk = { "id": 2621451, "name": "ExchangeDeclareOk", "args": [] };
...
function encodeExchangeDelete(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'ifUnused' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    val = fields['nowait'];
    if (val === undefined) {
...
var methodInfoExchangeDelete = module.exports.methodInfoExchangeDelete = { "id": 2621460, "name": "ExchangeDelete", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "exchange" }, { "type": "bit", "name": "ifUnused", "default": false }, { "type": "bit", "name": "nowait", "default": false }] };
...
var methodInfoExchangeDeleteOk = module.exports.methodInfoExchangeDeleteOk = { "id": 2621461, "name": "ExchangeDeleteOk", "args": [] };
...
function encodeExchangeBind(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'destination' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'source' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'routingKey' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    val = fields['destination'];
    if (val === undefined) val = undefined;
    buffer[offset] = destination_len; offset++;
    buffer.write(val, offset, "utf8"); offset += destination_len;
    val = fields['source'];
    if (val === undefined) val = undefined;
    buffer[offset] = source_len; offset++;
    buffer.write(val, offset, "utf8"); offset += source_len;
    val = fields['routingKey'];
    if (val === undefined) val = "";
    buffer[offset] = routingKey_len; offset++;
    buffer.write(val, offset, "utf8"); offset += routingKey_len;
    val = fields['nowait'];
    if (val === undefined) {
        val = false;
    }
...
var methodInfoExchangeBind = module.exports.methodInfoExchangeBind = { "id": 2621470, "name": "ExchangeBind", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "destination" }, { "type": "shortstr", "name": "source" }, { "type": "shortstr", "name": "routingKey", "default": "" }, { "type": "bit", "name": "nowait", "default": false }, { "type": "table", "name": "arguments", "default": {} }] };
...
var methodInfoExchangeBindOk = module.exports.methodInfoExchangeBindOk = { "id": 2621471, "name": "ExchangeBindOk", "args": [] };
...
var methodInfoExchangeUnbind = module.exports.methodInfoExchangeUnbind = { "id": 2621480, "name": "ExchangeUnbind", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "destination" }, { "type": "shortstr", "name": "source" }, { "type": "shortstr", "name": "routingKey", "default": "" }, { "type": "bit", "name": "nowait", "default": false }, { "type": "table", "name": "arguments", "default": {} }] };
...
var methodInfoExchangeUnbindOk = module.exports.methodInfoExchangeUnbindOk = { "id": 2621491, "name": "ExchangeUnbindOk", "args": [] };
...
function encodeQueueDeclare(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'queue' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    val = fields['queue'];
    if (val === undefined) val = "";
    buffer[offset] = queue_len; offset++;
    buffer.write(val, offset, "utf8"); offset += queue_len;
    val = fields['passive'];
    if (val === undefined) {
        val = false;
    }
...
var methodInfoQueueDeclare = module.exports.methodInfoQueueDeclare = { "id": 3276810, "name": "QueueDeclare", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "queue", "default": "" }, { "type": "bit", "name": "passive", "default": false }, { "type": "bit", "name": "durable", "default": false }, { "type": "bit", "name": "exclusive", "default": false }, { "type": "bit", "name": "autoDelete", "default": false }, { "type": "bit", "name": "nowait", "default": false }, { "type": "table", "name": "arguments", "default": {} }] };
...
function encodeQueueDeclareOk(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'messageCount' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt32BE(val, offset); offset += 4;
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'consumerCount' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt32BE(val, offset); offset += 4;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
...
var methodInfoQueueDeclareOk = module.exports.methodInfoQueueDeclareOk = { "id": 3276811, "name": "QueueDeclareOk", "args": [{ "type": "shortstr", "name": "queue" }, { "type": "long", "name": "messageCount" }, { "type": "long", "name": "consumerCount" }] };
...
var methodInfoQueueBind = module.exports.methodInfoQueueBind = { "id": 3276820, "name": "QueueBind", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "queue", "default": "" }, { "type": "shortstr", "name": "exchange" }, { "type": "shortstr", "name": "routingKey", "default": "" }, { "type": "bit", "name": "nowait", "default": false }, { "type": "table", "name": "arguments", "default": {} }] };
...
var methodInfoQueueBindOk = module.exports.methodInfoQueueBindOk = { "id": 3276821, "name": "QueueBindOk", "args": [] };
...
var methodInfoQueuePurge = module.exports.methodInfoQueuePurge = { "id": 3276830, "name": "QueuePurge", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "queue", "default": "" }, { "type": "bit", "name": "nowait", "default": false }] };
...
var methodInfoQueuePurgeOk = module.exports.methodInfoQueuePurgeOk = { "id": 3276831, "name": "QueuePurgeOk", "args": [{ "type": "long", "name": "messageCount" }] };
...
function encodeQueueDelete(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'ifEmpty' is the wrong type; must be booleany");
    }
    if (val) bits += 2;
    val = fields['nowait'];
    if (val === undefined) {
...
var methodInfoQueueDelete = module.exports.methodInfoQueueDelete = { "id": 3276840, "name": "QueueDelete", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "queue", "default": "" }, { "type": "bit", "name": "ifUnused", "default": false }, { "type": "bit", "name": "ifEmpty", "default": false }, { "type": "bit", "name": "nowait", "default": false }] };
...
var methodInfoQueueDeleteOk = module.exports.methodInfoQueueDeleteOk = { "id": 3276841, "name": "QueueDeleteOk", "args": [{ "type": "long", "name": "messageCount" }] };
...
var methodInfoQueueUnbind = module.exports.methodInfoQueueUnbind = { "id": 3276850, "name": "QueueUnbind", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "queue", "default": "" }, { "type": "shortstr", "name": "exchange" }, { "type": "shortstr", "name": "routingKey", "default": "" }, { "type": "table", "name": "arguments", "default": {} }] };
...
var methodInfoQueueUnbindOk = module.exports.methodInfoQueueUnbindOk = { "id": 3276851, "name": "QueueUnbindOk", "args": [] };
...
function encodeBasicQos(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'prefetchSize' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt32BE(val, offset); offset += 4;
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'prefetchCount' is the wrong type; must be a number (but not NaN)");
    }
    buffer.writeUInt16BE(val, offset); offset += 2;
    val = fields['global'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'global' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    buffer[offset] = bits; offset++;
    buffer[offset] = 206;
...
var methodInfoBasicQos = module.exports.methodInfoBasicQos = { "id": 3932170, "name": "BasicQos", "args": [{ "type": "long", "name": "prefetchSize", "default": 0 }, { "type": "short", "name": "prefetchCount", "default": 0 }, { "type": "bit", "name": "global", "default": false }] };
...
var methodInfoBasicQosOk = module.exports.methodInfoBasicQosOk = { "id": 3932171, "name": "BasicQosOk", "args": [] };
...
function encodeBasicConsume(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'consumerTag' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    val = fields['consumerTag'];
    if (val === undefined) val = "";
    buffer[offset] = consumerTag_len; offset++;
    buffer.write(val, offset, "utf8"); offset += consumerTag_len;
    val = fields['noLocal'];
    if (val === undefined) {
        val = false;
    }
        ...
        throw new TypeError(
            "Field 'noLocal' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    val = fields['noAck'];
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'noAck' is the wrong type; must be booleany");
    }
    if (val) bits += 2;
    val = fields['exclusive'];
    if (val === undefined) {
...
var methodInfoBasicConsume = module.exports.methodInfoBasicConsume = { "id": 3932180, "name": "BasicConsume", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "queue", "default": "" }, { "type": "shortstr", "name": "consumerTag", "default": "" }, { "type": "bit", "name": "noLocal", "default": false }, { "type": "bit", "name": "noAck", "default": false }, { "type": "bit", "name": "exclusive", "default": false }, { "type": "bit", "name": "nowait", "default": false }, { "type": "table", "name": "arguments", "default": {} }] };
...
var methodInfoBasicConsumeOk = module.exports.methodInfoBasicConsumeOk = { "id": 3932181, "name": "BasicConsumeOk", "args": [{ "type": "shortstr", "name": "consumerTag" }] };
...
var methodInfoBasicCancel = module.exports.methodInfoBasicCancel = { "id": 3932190, "name": "BasicCancel", "args": [{ "type": "shortstr", "name": "consumerTag" }, { "type": "bit", "name": "nowait", "default": false }] };
...
var methodInfoBasicCancelOk = module.exports.methodInfoBasicCancelOk = { "id": 3932191, "name": "BasicCancelOk", "args": [{ "type": "shortstr", "name": "consumerTag" }] };
...
function encodeBasicPublish(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'mandatory' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'immediate' is the wrong type; must be booleany");
    }
    if (val) bits += 2;
    buffer[offset] = bits; offset++;
    buffer[offset] = 206;
...
var methodInfoBasicPublish = module.exports.methodInfoBasicPublish = { "id": 3932200, "name": "BasicPublish", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "exchange", "default": "" }, { "type": "shortstr", "name": "routingKey", "default": "" }, { "type": "bit", "name": "mandatory", "default": false }, { "type": "bit", "name": "immediate", "default": false }] };
...
var methodInfoBasicReturn = module.exports.methodInfoBasicReturn = { "id": 3932210, "name": "BasicReturn", "args": [{ "type": "short", "name": "replyCode" }, { "type": "shortstr", "name": "replyText", "default": "" }, { "type": "shortstr", "name": "exchange" }, { "type": "shortstr", "name": "routingKey" }] };
...
function decodeBasicDeliver(buffer) {
    ...
    offset += len;
    fields['consumerTag'] = val;
    val = ints.readUInt64BE(buffer, offset); offset += 8;
...
function encodeBasicDeliver(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'deliveryTag' is the wrong type; must be a number (but not NaN)");
    }
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'redelivered' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    buffer[offset] = bits; offset++; bits = 0;
    val = fields['exchange'];
...
var methodInfoBasicDeliver = module.exports.methodInfoBasicDeliver = { "id": 3932220, "name": "BasicDeliver", "args": [{ "type": "shortstr", "name": "consumerTag" }, { "type": "longlong", "name": "deliveryTag" }, { "type": "bit", "name": "redelivered", "default": false }, { "type": "shortstr", "name": "exchange" }, { "type": "shortstr", "name": "routingKey" }] };
...
var methodInfoBasicGet = module.exports.methodInfoBasicGet = { "id": 3932230, "name": "BasicGet", "args": [{ "type": "short", "name": "ticket", "default": 0 }, { "type": "shortstr", "name": "queue", "default": "" }, { "type": "bit", "name": "noAck", "default": false }] };
...
var methodInfoBasicGetOk = module.exports.methodInfoBasicGetOk = { "id": 3932231, "name": "BasicGetOk", "args": [{ "type": "longlong", "name": "deliveryTag" }, { "type": "bit", "name": "redelivered", "default": false }, { "type": "shortstr", "name": "exchange" }, { "type": "shortstr", "name": "routingKey" }, { "type": "long", "name": "messageCount" }] };
...
function encodeBasicGetEmpty(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'clusterId' is the wrong type; must be a string (up to 255 chars)");
    }
    ...
    val = fields['clusterId'];
    if (val === undefined) val = "";
    buffer[offset] = clusterId_len; offset++;
    buffer.write(val, offset, "utf8"); offset += clusterId_len;
    buffer[offset] = 206;
    buffer.writeUInt32BE(offset - 7, 3);
    return buffer;
}

var methodInfoBasicGetEmpty = module.exports.methodInfoBasicGetEmpty = { "id": 3932232, "name": "BasicGetEmpty", "args": [{ "type": "shortstr", "name": "clusterId", "default": "" }] };
...
function encodeBasicAck(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'multiple' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    buffer[offset] = bits; offset++;
    buffer[offset] = 206;
...
var methodInfoBasicAck = module.exports.methodInfoBasicAck = { "id": 3932240, "name": "BasicAck", "args": [{ "type": "longlong", "name": "deliveryTag", "default": 0 }, { "type": "bit", "name": "multiple", "default": false }] };
...
function encodeBasicReject(channel, fields) {
    ...
    if (val === undefined) {
        ...
        throw new TypeError(
            "Field 'requeue' is the wrong type; must be booleany");
    }
    if (val) bits += 1;
    buffer[offset] = bits; offset++;
    buffer[offset] = 206;
...
var methodInfoBasicReject = module.exports.methodInfoBasicReject = { "id": 3932250, "name": "BasicReject", "args": [{ "type": "longlong", "name": "deliveryTag" }, { "type": "bit", "name": "requeue", "default": true }] };
...
var methodInfoBasicRecoverAsync = module.exports.methodInfoBasicRecoverAsync = { "id": 3932260, "name": "BasicRecoverAsync", "args": [{ "type": "bit", "name": "requeue", "default": false }] };
...
var methodInfoBasicRecover = module.exports.methodInfoBasicRecover = { "id": 3932270, "name": "BasicRecover", "args": [{ "type": "bit", "name": "requeue", "default": false }] };
...
var methodInfoBasicRecoverOk = module.exports.methodInfoBasicRecoverOk = { "id": 3932271, "name": "BasicRecoverOk", "args": [] };
...
var methodInfoBasicNack = module.exports.methodInfoBasicNack = { "id": 3932280, "name": "BasicNack", "args": [{ "type": "longlong", "name": "deliveryTag", "default": 0 }, { "type": "bit", "name": "multiple", "default": false }, { "type": "bit", "name": "requeue", "default": true }] };
...
var methodInfoTxSelect = module.exports.methodInfoTxSelect = { "id": 5898250, "name": "TxSelect", "args": [] };
...
var methodInfoTxSelectOk = module.exports.methodInfoTxSelectOk = { "id": 5898251, "name": "TxSelectOk", "args": [] };
...
var methodInfoTxCommit = module.exports.methodInfoTxCommit = { "id": 5898260, "name": "TxCommit", "args": [] };
...
var methodInfoTxCommitOk = module.exports.methodInfoTxCommitOk = { "id": 5898261, "name": "TxCommitOk", "args": [] };
...
var methodInfoTxRollback = module.exports.methodInfoTxRollback = { "id": 5898270, "name": "TxRollback", "args": [] };
...
var methodInfoTxRollbackOk = module.exports.methodInfoTxRollbackOk = { "id": 5898271, "name": "TxRollbackOk", "args": [] };
...
var methodInfoConfirmSelect = module.exports.methodInfoConfirmSelect = { "id": 5570570, "name": "ConfirmSelect", "args": [{ "type": "bit", "name": "nowait", "default": false }] };
...
var methodInfoConfirmSelectOk = module.exports.methodInfoConfirmSelectOk = { "id": 5570571, "name": "ConfirmSelectOk", "args": [] };

module.exports.BasicProperties = 60;
function encodeBasicProperties(channel, size, fields) {
    var offset = 0, flags = 0, val, len;
    var scratchOffset = 0, varyingSize = 0;
    ...
    if (val != undefined) {
        if (typeof val === 'object') {
            ...
            throw new TypeError(
                "Field 'headers' is the wrong type; must be an object");
        }
    }
    ...
    if (val != undefined) {
        if (typeof val === 'number' && !isNaN(val)) {
            ...
            throw new TypeError(
                "Field 'deliveryMode' is the wrong type; must be a number (but not NaN)");
        }
    }
    val = fields['priority'];
    if (val != undefined) {
        if (typeof val === 'number' && !isNaN(val)) {
            ...
            throw new TypeError(
                "Field 'priority' is the wrong type; must be a number (but not NaN)");
        }
    }
    ...
    if (val != undefined) {
        if (typeof val === 'string' && Buffer.byteLength(val) < 256) {
            ...
            throw new TypeError(
                "Field 'replyTo' is the wrong type; must be a string (up to 255 chars)");
        }
    }
    ...
    if (val != undefined) {
        if (typeof val === 'string' && Buffer.byteLength(val) < 256) {
            ...
            throw new TypeError(
                "Field 'messageId' is the wrong type; must be a string (up to 255 chars)");
        }
    }
    ...
    if (val != undefined) {
        if (typeof val === 'number' && !isNaN(val)) {
            ...
            throw new TypeError(
                "Field 'timestamp' is the wrong type; must be a number (but not NaN)");
        }
    }
    val = fields['type'];
    if (val != undefined) {
    ...
    if (val != undefined) {
        if (typeof val === 'string' && Buffer.byteLength(val) < 256) {
            ...
            throw new TypeError(
                "Field 'userId' is the wrong type; must be a string (up to 255 chars)");
        }
    }
    val = fields['appId'];
    if (val != undefined) {
        if (typeof val === 'string' && Buffer.byteLength(val) < 256) {
            ...
            throw new TypeError(
                "Field 'appId' is the wrong type; must be a string (up to 255 chars)");
        }
    }
    val = fields['clusterId'];
    if (val != undefined) {
    ...
    if (val != undefined) {
        flags += 32768;
        buffer[offset] = contentType_len; offset++;
    ...
    if (val != undefined) {
        flags += 16384;
        buffer[offset] = contentEncoding_len; offset++;
        buffer.write(val, offset, 'utf8');
    ...
    if (val != undefined) {
        flags += 1024;
        buffer[offset] = correlationId_len; offset++;
        buffer.write(val, offset, 'utf8');
    ...
    if (val != undefined) {
        flags += 512;
        buffer[offset] = replyTo_len; offset++;
        buffer.write(val, offset, 'utf8');
        offset += replyTo_len;
    }
    val = fields['expiration'];
    if (val != undefined) {
        flags += 256;
        buffer[offset] = expiration_len; offset++;
        buffer.write(val, offset, 'utf8');
    ...
    if (val != undefined) {
        flags += 128;
        buffer[offset] = messageId_len; offset++;
        buffer.write(val, offset, 'utf8');
    ...
    if (val != undefined) {
        flags += 16;
        buffer[offset] = userId_len; offset++;
        buffer.write(val, offset, 'utf8');
        offset += userId_len;
    }
    val = fields['appId'];
    if (val != undefined) {
        flags += 8;
        buffer[offset] = appId_len; offset++;
        buffer.write(val, offset, 'utf8');
        offset += appId_len;
    }
    val = fields['clusterId'];
